...
{
	return (base_url() == 'http://192.168.43.135/indotaku/')
		? "http://192.168.43.135/komikins/assets/image/komik/"
		: "http://localhost/komikins/assets/image/komik/";
}

function get_chapter_cover(string $param): string
{
	return (base_url() == 'http://192.168.43.135/indotaku/')
		? "http://192.168.43.135/komikins/" . $param
		: "http://localhost/komikins/" . $param;
}
